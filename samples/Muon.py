...
muon.add("SingleMu.2011A-May.1",'%s/bbetchar/ICF/automated/2011_11_06_08_14_36/")'%srm, lumi = 1)
muon.add("SingleMu.2011A-PR4.1",'%s/bbetchar/ICF/automated/2011_11_06_08_25_27/")'%srm, lumi = 1)
muon.add("SingleMu.2011A-Aug.1",'%s/bbetchar/ICF/automated/2011_11_06_08_35_40/")'%srm, lumi = 1)
muon.add("SingleMu.2011A-Oct.1",'%s/bbetchar/ICF/automated/2011_11_06_08_44_13/")'%srm, lumi = 1)
muon.add("SingleMu.2011B-PR1.1a",'%s//bbetchar/ICF/automated/2011_11_06_20_02_03/")'%srm, lumi = 1)
muon.add("SingleMu.2011B-PR1.1b",'%s//bbetchar/ICF/automated/2011_11_06_20_11_30/")'%srm, lumi = 1)
