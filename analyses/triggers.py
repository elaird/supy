...
class triggers(analysis.analysis) :
    ...
    def listOfSteps(self, params) :
        return [
            ...
            steps.Trigger.hltTurnOnHistogrammer( "%sLeadingPt%s"%params["muon"], (40,0,40), "HLT_Mu9",["HLT_Mu%d"%d for d in [5,3]]),
            steps.Trigger.hltTurnOnHistogrammer( "%sLeadingPt%s"%params["muon"], (40,0,40), "HLT_Mu15_v1",["HLT_Mu%d"%d for d in [9,7,5,3]]),
            ]
