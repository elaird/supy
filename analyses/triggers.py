...
class triggers(analysis.analysis) :
    ...
    def listOfSteps(self, pars) :
        return (
            [steps.Print.progressPrinter(),
             ...
             steps.Trigger.hltTurnOnHistogrammer( "%sLeadingPtAny%s"%pars["muon"], (80,0,40), "HLT_Mu30_v3",["HLT_Mu%d_v%d"%d for d in [(20,2),(20,1),(24,3),(24,4)]]),
    ...
    def listOfSamples(self,pars) :
        return ( samples.specify(names = "SingleMu.Run2011A-PR-v4.FJ.Burt", color = r.kBlack) +
