...
a.addSample( sampleName="JetMETTau.Run2010A", nMaxFiles = -1, nEvents = -1, lumi = 0.012+0.120+0.1235,#/pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/data1/")' )

##OTHER DATA SKIM
a.addSample( sampleName="JetMETTau.Run2010A_skim2", nMaxFiles = -1, nEvents = -1, lumi = 0.012+0.120+0.1235,#/pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/alphaT.gt.0.525/data/")' )

#PY QCD SKIMS
a.addSample( sampleName="qcd_py_pt80_skim", nMaxFiles = -1, nEvents = -1, xs = 0.894,#pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/qcd_high_alphaT/pt80/")' )
a.addSample( sampleName="qcd_py_pt170_skim", nMaxFiles = -1, nEvents = -1, xs = 0.377,#pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/qcd_high_alphaT/pt170/")' )
a.addSample( sampleName="qcd_py_pt300_skim", nMaxFiles = -1, nEvents = -1, xs = 0.0409,#pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/qcd_high_alphaT/pt300/")' )
a.addSample( sampleName="qcd_py_pt470_skim", nMaxFiles = -1, nEvents = -1, xs = 0.002362,#pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/qcd_high_alphaT/pt470/")' )
...
#OTHER PY QCD SKIMS
a.addSample( sampleName="qcd_py_pt30_skim2", nMaxFiles = -1, nEvents = -1, xs = 12.56,#pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/alphaT.gt.0.525/pt30/")' )
a.addSample( sampleName="qcd_py_pt80_skim2", nMaxFiles = -1, nEvents = -1, xs = 4.9,#pb
             fileListCommand = 'utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/alphaT.gt.0.525/pt80/")' )
a.manageNonBinnedSamples(ptHatLowerThresholdsAndSampleNames=[(30,"qcd_py_pt30_skim2"),
                                                             (80,"qcd_py_pt80_skim2"),
                                                             ])

###PY QCD
a.addSample( sampleName="qcd_py_pt30", nMaxFiles = -1, nEvents = -1, xs = 6.041e+07,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/gouskos//ICF/automated/2010_06_24_18_09_51/")' )
a.addSample( sampleName="qcd_py_pt80", nMaxFiles = -1, nEvents = -1, xs = 9.238e+05,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/gouskos//ICF/automated/2010_07_06_00_55_17/")' )
a.addSample( sampleName="qcd_py_pt170", nMaxFiles = -1, nEvents = -1, xs = 2.547e+04,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/gouskos//ICF/automated/2010_07_06_01_33_23/")' )
a.addSample( sampleName="qcd_py_pt300", nMaxFiles = -1, nEvents = -1, xs = 1.256e+03,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/gouskos//ICF/automated/2010_07_09_19_13_09/")' )
a.addSample( sampleName="qcd_py_pt470", nMaxFiles = -1, nEvents = -1, xs = 8.798e+01,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/gouskos//ICF/automated/2010_07_10_04_22_06/")' )
a.addSample( sampleName="qcd_py_pt800", nMaxFiles = -1, nEvents = -1, xs = 2.186e+00,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/gouskos//ICF/automated/2010_07_10_04_37_56/")' )
a.addSample( sampleName="qcd_py_pt1400", nMaxFiles = -1, nEvents = -1, xs = 1.122e-02,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/gouskos//ICF/automated/2010_07_10_04_47_48/")' )
...
a.addSample( sampleName="gammajets_mg_pt40_100", nMaxFiles = -1, nEvents = -1, xs = 23620,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/arlogb//ICF/automated/2010_07_26_15_14_40//PhotonJets_Pt40to100-madgraph.Spring10-START3X_V26_S09-v1.GEN-SIM-RECO/")' )
a.addSample( sampleName="gammajets_mg_pt100_200", nMaxFiles = -1, nEvents = -1, xs = 3476,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/arlogb/ICF/automated/2010_07_26_15_14_40/PhotonJets_Pt100to200-madgraph.Spring10-START3X_V26_S09-v1.GEN-SIM-RECO/")' )
a.addSample( sampleName="gammajets_mg_pt200", nMaxFiles = -1, nEvents = -1, xs = 485,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/arlogb/ICF/automated/2010_07_26_15_14_40/PhotonJets_Pt200toInf-madgraph.Spring10-START3X_V26_S09-v1.GEN-SIM-RECO/")' )

#OTHER
a.addSample( sampleName="tt_tauola_mg", nMaxFiles = -1, nEvents = -1, xs = 95.0,#pb
             fileListCommand = 'utils.getCommandOutput2("ls /vols/cms01/mstoye/ttTauola_madgraph_V11tag/SusyCAF_Tree*.root | grep -v 4_2").split("\n")' )

a.addSample( sampleName="z_inv_mg", nMaxFiles = -1, nEvents = -1, xs=4500.0,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/zph04/ICF/automated/2010_07_14_11_52_58/",itemsToSkip=["14_3.root"])')

a.addSample( sampleName="z_jets_mg", nMaxFiles = -1, nEvents = -1, xs=2400.0,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/jad/ICF/automated//2010_07_05_22_43_20/", pruneList=False)' )

a.addSample( sampleName="w_jets_mg", nMaxFiles = -1, nEvents = -1, xs=24170.0,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/jad/ICF/automated//2010_06_18_22_33_23/")' )

a.addSample( sampleName="lm0", nMaxFiles = -1, nEvents = -1, xs = 38.93,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/bainbrid/ICF/automated/2010_07_16_12_54_00/LM0.Spring10-START3X_V26_S09-v1.GEN-SIM-RECO/")' )

a.addSample( sampleName="lm1", nMaxFiles = -1, nEvents = -1, xs = 4.888,#pb
             fileListCommand = 'utils.fileListFromSrmLs(location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/bainbrid/ICF/automated/2010_07_12_17_52_54/LM1.Spring10-START3X_V26_S09-v1.GEN-SIM-RECO/")' )
