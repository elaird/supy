...
a.addSample(sampleName = "JetMETTau.Run2010A",
            listOfFileNames = utils.fileListFromDisk(location="/vols/cms02/elaird1/06_skims/take2/JetMETTau.Run2010A-Jul16thReReco-v1.RECO.Bryn",pruneList=False),
            nEvents = -1,
            nMaxFiles = 1,
            lumi = 0.120,#/pb
            )
