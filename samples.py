...
class sampleDictionaryHolder :
    ...
    def add_EarlyJuneSamples(self) :
        ...
        #                              sizeThreshold=0
        #                              )
        #self.registerSamplesFromSrmLs(name="MinimumBias.Commissioning10-May6thPDSkim2_SD_JetMETTau-v1.RECO",
        #                              location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/bbetchar//ICF/automated/2010_06_08_04_00_40/",
        #                              itemsToExclude=[],
        #                              sizeThreshold=0
        #                              )
        #self.registerSamplesFromSrmLs(name="MinimumBias.Commissioning10-SD_JetMETTau-v9.RECO",
        #                              location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/bbetchar//ICF/automated/2010_06_08_03_44_12/",
        #                              itemsToExclude=["10_1","28_1","26_1","56_2"],
        #                              sizeThreshold=0
        #                              )
        #self.registerSamplesFromSrmLs(name="QCD_Pt-15_7TeV-pythia8.Spring10-START3X_V26B-v1.GEN-SIM-RECO",
        #                              location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/elaird//ICF/automated/2010_06_04_18_22_38/",
        #                              itemsToExclude=[],
        #                              sizeThreshold=0
        #                              )
        #self.registerSamplesFromSrmLs(name="QCD_Pt-15_7TeV.pythia6.Spring10-START3X_V26B-v1.GEN-SIM-RECO",
        #                              location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/bbetchar//ICF/automated/2010_06_12_02_55_20/",
        #                              itemsToExclude=[],
        #                              sizeThreshold=0
        #                              )
        return
    
    def add_June25Samples(self) :
        #self.registerSamplesFromSrmLs(name="JetMETTau.Run2010A-Jun9thReReco_v1.RECO",
        #                              location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/henning//ICF/automated/2010_06_25_18_16_45/",
        #                              itemsToExclude=[],
        #                              sizeThreshold=0
        #                              )
        #self.registerSamplesFromSrmLs(name="MinimumBias.Commissioning10-SD_JetMETTau-Jun9thSkim_v1.RECO",
        #                              location="/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/henning//ICF/automated/2010_06_25_18_06_57/",
        #                              itemsToExclude=[],
        #                              sizeThreshold=0
        #                              )
